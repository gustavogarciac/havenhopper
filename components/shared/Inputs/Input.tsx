...
import { registerModalFormInputs } from "@/components/modals/RegisterModal";
...
const Input = ({
  ...
  return (
    <div className="relative w-full">
      ...
      />
      <label
        className={`text-md absolute top-5 z-10 origin-[0] -translate-y-3 transform capitalize duration-150 ${
